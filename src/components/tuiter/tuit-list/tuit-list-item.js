...
const TuitListItem = ({tuit}) => {
    ...
    // console.log('username to render: ' + JSON.stringify(tuit.postedBy.username));
    return (
        <div>
            <li>
                <div className={"list-group-item position-relative"}>
                    ...
                    <div className={"mx-0 ms-2 mb-2"}>
                        ...
                        {tuit.attachments &&
                            (<img src={tuit.attachments.image} className={"img-fluid ms-5 mt-3 w-75 attachment-image"}
                                  alt={"attachment"}/>)}
                    </div>
                    <TuitStats tuit={tuit}/>
                </div>
